...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gestureView.addOnGesturePerformedListener(new GestureOverlayView.
            ...
            public void onGesturePerformed(GestureOverlayView overlay, Gesture
                ...
                // 使用对话框显示dialog组件
                new AlertDialog.Builder(ResultActivity.this).setView(dialog)
    ...
    public void saveFile(){
        if(mGesture != null){
            ...
            if(result) Toast.makeText(ResultActivity.this,"保存成功",
                    Toast.LENGTH_SHORT).show();
            else Toast.makeText(ResultActivity.this,"保存失败",
                    Toast.LENGTH_SHORT).show();
